...
const AdminReviews = () => {
    ...
    //     setLoading(true);
    //     try {
    //         const res = await axios.get("http://localhost:3000/api/admin/reviews", { withCredentials: true });
    ...
    const deleteReview = async (id) => {
        ...
        try {
            await axios.delete(`http://localhost:3000/api/admin/reviews/${id}`, { withCredentials: true });
