...
const Chat = () => {
  ...
  const fetchConversations = useCallback(async () => {
    ...
    try {
      ...
      const res = await axios.get('http://localhost:3000/api/chat/conversations?role=student', { withCredentials: true });
  ...
  const selectConversation = async (id) => {
    ...
    setLoadingMsgs(true);
    try {
      const res = await axios.get(`http://localhost:3000/api/chat/conversations/${id}/messages`, { withCredentials: true });
      setMessages(res.data.messages || []);
      
      await axios.put(`http://localhost:3000/api/chat/conversations/${id}/read`, {}, { withCredentials: true });
